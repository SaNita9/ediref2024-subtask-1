...
from bert_utils import mask_fill
...
class Classifier(pl.LightningModule):
    ...
    def __init__(self, hparams: Namespace) -> None:
        ...
        self.f1macro=MulticlassF1Score(num_classes=8, average='macro')
        self.f1weighted=MulticlassF1Score(num_classes=8, average='weighted')
